<footer class="bg-gray-50 text-slate-600 py-16 border-t border-slate-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Main Footer: Brand Left + Links Right (desktop), stacked (mobile) -->
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 mb-12 pb-12 border-b border-slate-100">
            <!-- Brand Section -->
            <div>
            ...
            <div class="pl-0 md:pl-0">
                ...
                <!-- Follow Us -->
                <div>
                    <h4 class="footer-heading text-slate-900 font-bold mb-3 uppercase tracking-wider text-xs md:text-sm" data-i18n
