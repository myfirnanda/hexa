...
@section('topbar-title', 'Tambah Testimonial')
...
<div class="flex items-center justify-between flex-wrap gap-4 mb-7 max-md:flex-col max-md:items-start">
    <h1 class="text-2xl font-bold">Tambah Testimonial Baru</h1>
</div>
        ...
        <form method="POST" action="{{ route('manager.testimonials.store') }}">
            ...
            <div id="fields-en">
                <div class="mb-5">
                    ...
                    <input type="text" class="w-full px-3.5 py-2.5 rounded-lg admin-input font-[inherit] text-sm outline-none transition-colors duration-200 focus:border-blue-500" id="role" name="role" value="{{ old('role') }}" required placeholder="CEO, Manager, etc...">
                ...
                <div class="mb-5">
                    ...
                    <textarea class="w-full px-3.5 py-2.5 rounded-lg admin-input font-[inherit] text-sm outline-none transition-colors duration-200 focus:border-blue-500 resize-y min-h-[100px]" id="quote" name="quote" required placeholder="Testimonial content...">{{ old('quote') }}</textarea>
            ...
            <div id="fields-id" class="hidden">
                <div class="mb-5">
                    ...
                    <input type="text" class="w-full px-3.5 py-2.5 rounded-lg admin-input font-[inherit] text-sm outline-none transition-colors duration-200 focus:border-blue-500" id="role_id" name="role_id" value="{{ old('role_id') }}" placeholder="CEO, Manager, dsb...">
                ...
                <div class="mb-5">
                    ...
                    <textarea class="w-full px-3.5 py-2.5 rounded-lg admin-input font-[inherit] text-sm outline-none transition-colors duration-200 focus:border-blue-500 resize-y min-h-[100px]" id="quote_id" name="quote_id" placeholder="Isi testimoni...">{{ old('quote_id') }}</textarea>
