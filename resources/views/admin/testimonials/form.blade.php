...
@section('topbar-title', isset($testimonial) ? 'Edit Testimonial' : 'Tambah Testimonial')
...
<div class="flex items-center justify-between flex-wrap gap-4 mb-7 max-md:flex-col max-md:items-start">
    <h1 class="text-2xl font-bold">{{ isset($testimonial) ? 'Edit Testimonial' : 'Tambah Testimonial Baru' }}</h1>
</div>
