...
<div class="admin-card border rounded-xl overflow-hidden">
    <div class="p-5">
        <form method="POST" action="{{ route('manager.projects.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div id="fields-en">
                ...
                <div class="mb-5">
                    ...
                    <textarea class="w-full px-3.5 py-2.5 rounded-lg admin-input font-[inherit] text-sm outline-none transition-colors duration-200 focus:border-blue-500" id="hero_description" name="hero_description" rows="3" placeholder="Short description for hero section...">{{ old('hero_description') }}</textarea>
            ...
            <div id="fields-id" class="hidden">
                <div class="mb-5">
                    ...
                    <input type="text" class="w-full px-3.5 py-2.5 rounded-lg admin-input font-[inherit] text-sm outline-none transition-colors duration-200 focus:border-blue-500" id="summary_title_id" name="summary_title_id" value="{{ old('summary_title_id') }}" placeholder="Belajar Tentang ...">
                ...
                <div class="mb-5">
                    ...
                    <textarea class="w-full px-3.5 py-2.5 rounded-lg admin-input font-[inherit] text-sm outline-none transition-colors duration-200 focus:border-blue-500" id="hero_description_id" name="hero_description_id" rows="3" placeholder="Deskripsi singkat untuk hero section...">{{ old('hero_description_id') }}</textarea>
                ...
                <div class="mb-5">
                    ...
                    <textarea id="description_id" name="description_id">{{ old('description_id') }}</textarea>
