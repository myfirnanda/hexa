...
@section('topbar-title', 'Edit Kategori Produk')
...
<div class="max-w-2xl">
    <div class="admin-card border rounded-xl p-6">
        <h2 class="text-lg font-bold admin-text mb-6">Edit Kategori Produk</h2>

        <form method="POST" action="{{ route('manager.product-categories.update', $category) }}">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <div class="p-4 rounded-lg admin-surface-hover">
                        <span class="inline-block px-3 py-1.5 rounded-full text-white text-sm font-bold" id="preview-badge" style="background-color: {{ old('color', $category->color) }};">
...
document.getElementById('name').addEventListener('input', function() {
    document.getElementById('preview-badge').textContent = this.value || 'Preview Kategori';
});
</script>
@endsection
