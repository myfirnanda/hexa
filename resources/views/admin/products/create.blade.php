...
<form method="POST" action="{{ route('manager.products.store') }}" enctype="multipart/form-data" id="productForm">
    @csrf
    ...
    <div class="admin-card border rounded-xl overflow-hidden mb-6">
        ...
        <div class="p-5 space-y-5">
            ...
            <div>
                ...
                <div id="fields-en">
                    <div class="mb-4">
                        ...
                        <input type="text" class="w-full px-3.5 py-2.5 rounded-lg admin-input font-[inherit] text-sm outline-none transition-colors duration-200 focus:border-blue-500" id="tagline" name="tagline" value="{{ old('tagline') }}" placeholder="Short catchy tagline...">
                    ...
                    <div>
                        ...
                        <textarea class="w-full px-3.5 py-2.5 rounded-lg admin-input font-[inherit] text-sm outline-none transition-colors duration-200 focus:border-blue-500 resize-y" style="min-height: 120px" id="description" name="description" placeholder="Product description...">{{ old('description') }}</textarea>
                ...
                <div id="fields-id" class="hidden">
                    <div class="mb-4">
                        ...
                        <input type="text" class="w-full px-3.5 py-2.5 rounded-lg admin-input font-[inherit] text-sm outline-none transition-colors duration-200 focus:border-blue-500" id="tagline_id" name="tagline_id" value="{{ old('tagline_id') }}" placeholder="Tagline singkat...">
                    ...
                    <div>
                        ...
                        <textarea class="w-full px-3.5 py-2.5 rounded-lg admin-input font-[inherit] text-sm outline-none transition-colors duration-200 focus:border-blue-500 resize-y" style="min-height: 120px" id="description_id" name="description_id" placeholder="Deskripsi singkat produk...">{{ old('description_id') }}</textarea>
            ...
            <div>
                ...
                <input type="url" class="w-full px-3.5 py-2.5 rounded-lg admin-input font-[inherit] text-sm outline-none transition-colors duration-200 focus:border-blue-500" id="website_url" name="website_url" value="{{ old('website_url') }}" placeholder="https://example.com">
...
$(function () {
    ...
    if (oldFeatures && typeof oldFeatures === 'object' && Object.keys(oldFeatures).length > 0) {
        $.each(oldFeatures, function (idx, fData) {
            if (!fData) return;
            var itemsArr = fData.items ? Object.values(fData.items) : [''];
            $('#features-container').append(createFeatureHtml(featureIndex, {
                title: fData.title || '',
                icon: fData.icon || '',
