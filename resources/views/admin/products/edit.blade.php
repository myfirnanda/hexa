        ...
        <div class="p-5 space-y-5">
            <div class="grid grid-cols-2 gap-4 max-md:grid-cols-1">
                ...
                <div>
                    ...
                    <input type="text" class="w-full px-3.5 py-2.5 rounded-lg admin-input font-[inherit] text-sm outline-none transition-colors duration-200 focus:border-blue-500" id="tagline" name="tagline" value="{{ old('tagline', $product->tagline) }}" placeholder="Tagline singkat...">
            ...
            <div>
                ...
                <textarea class="w-full px-3.5 py-2.5 rounded-lg admin-input font-[inherit] text-sm outline-none transition-colors duration-200 focus:border-blue-500 resize-y min-h-[100px]" id="description" name="description" placeholder="Deskripsi produk...">{{ old('description', $product->description) }}</textarea>
